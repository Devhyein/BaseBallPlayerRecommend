...
public class hit_info {
    ...
    public hit_info(int score_id, int simulation_id, String my_score, String your_score) {
    ...
    public hit_info(int score_id, int simulation_id, int[] my_score_array, int[] your_score_array) {
        this.score_id = score_id;
        this.simulation_id = simulation_id;
