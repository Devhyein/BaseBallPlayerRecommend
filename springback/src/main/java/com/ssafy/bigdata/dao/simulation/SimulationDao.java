...
public interface SimulationDao {
    ...
    // 시뮬레이션 생성
    public int createSimulation(int user_id, int my_lineup_id, int your_lineup_id, boolean is_attack, int innings, boolean is_top, int out_count, String base_info, String my_score, String your_score, int my_hit_order, int your_hit_order, int game_status);
